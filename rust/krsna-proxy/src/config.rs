...
fn default_upstream_url() -> String { "http://localhost:3000".to_string() }
fn default_posture() -> Posture { Posture::Monitor }
fn default_mgmt_api_url() -> String { "http://localhost:8000".to_string() }
...
fn default_recovery_timeout() -> u64 { 30 }
...
fn default_required_role() -> String { "admin".to_string() }
...
impl Config {
    pub fn load() -> anyhow::Result<Self> {
        ...
        Ok(Config {
            ...
            database_url: std::env::var("TRAKSHYA_DATABASE_URL").unwrap_or_else(|_| "sqlite:./data/trakshya.db".to_string()),
        })
    }
}
